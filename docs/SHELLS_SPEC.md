...
Regenerated procedurally against the original's measured geometry and palette, not resampled:

- Identical palette per colour family, e.g. orange = smoke `#787880`, dark `#DC461E`, mid `#FF9628`, core `#FFEC78`.
- Shared casing colours across all rows: dark `#464852`, highlight `#787A84`, gold nose `#D2B446`.
