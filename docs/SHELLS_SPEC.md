...
- Palette per colour family (dark / mid / core / smoke): orange = smoke `#7E7E7E`, dark `#E44219`, mid `#EEA343`, core `#CAC594`; red = smoke `#373737`, dark `#9C3527`, mid `#FF421A`, core `#DC9C4A`; blue = smoke `#C1C1C1`, dark `#038AAB`, mid `#27D8C5`, core `#FFFFFF` (a white spark core — Puny World has nothing brighter than actual white either). Smoke tones are true neutral greys since the 2026-08 de-green pass — they were olive (`#5D654F`/`#4C523C`/`#ACB7A1`) before, back when the palette's STONE family was sampled from Puny World's green-grey building walls.
- Shared casing colours across all rows: dark `#7E7E7E`, highlight `#C1C1C1`, bronze-gold nose `#DE9943`.
