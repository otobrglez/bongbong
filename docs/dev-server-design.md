...
field pixels (the map's `size`; the shipped default is 960x480), y down, rotation 0 = up.
...
`[col, row]` on the 32 px grid (the map's `size`, 30 x 15 by default); window positions for
