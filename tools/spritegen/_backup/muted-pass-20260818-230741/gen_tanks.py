...
# ----------------------------------------------------------------------
# Body/accent are curated picks from RESURRECT64 (not auto-snapped) -- each
# tank keeps its original role-family (cyan recon/support, amber general-
# purpose, red brawler, etc.) but drawn from the palette's actual saturated
# hues instead of the old desaturated military tones, for a more vibrant,
# "pop" read. The original roster reused the exact same cyan accent
# (102, 195, 226) for FOUR tanks (scout/flak/warden/leviathan); here each
# gets its own step along the palette's teal->cyan->sky-blue ramp instead so
# they're distinguishable at a glance, not just recolored 1:1.
TANKS = [
    dict(name='scout',   body=(0x54, 0x7E, 0x64), accent=(0x30, 0xE1, 0xB9), build='narrow',
         nose='wedge',   tread='fine',  deck='ribbed', thrusters=2, sponson=False,
         tshape='round', tr=4.1, guns=1, bw=2, blen=8,  gap=0, optic=(13, 13)),
    dict(name='assault', body=(0x67, 0x66, 0x33), accent=(0xF7, 0x96, 0x17), build='std',
         nose='chamfer', tread='seg',   deck='plates', thrusters=3, sponson=True,
         tshape='box',   tr=4.7, guns=2, bw=2, blen=6,  gap=3, optic=(12, 18)),
    dict(name='breaker', body=(0x62, 0x55, 0x65), accent=(0xEA, 0x4F, 0x36), build='wide',
         nose='blunt',   tread='block', deck='ribbed', thrusters=4, sponson=True,
         tshape='hex',   tr=5.2, guns=1, bw=4, blen=5,  gap=0, optic=(12, 13)),
    dict(name='longbow', body=(0x16, 0x5A, 0x4C), accent=(0x91, 0xDB, 0x69), build='long',
         nose='chamfer', tread='seg',   deck='plates', thrusters=2, sponson=False,
         tshape='round', tr=4.3, guns=1, bw=2, blen=11, gap=0, optic=(13, 13)),
    dict(name='flak',    body=(0x31, 0x36, 0x38), accent=(0x4D, 0x9B, 0xE6), build='compact',
         nose='blunt',   tread='block', deck='ribbed', thrusters=2, sponson=False,
         tshape='hex',   tr=4.5, guns=2, bw=2, blen=4,  gap=3, optic=(12, 18)),
    dict(name='wraith',  body=(0x45, 0x29, 0x3F), accent=(0xA8, 0x84, 0xF3), build='narrow',
         nose='wedge',   tread='fine',  deck='plates', thrusters=2, sponson=False,
         tshape='wedge', tr=4.3, guns=1, bw=2, blen=7,  gap=0, optic=(13, 13)),
    dict(name='warden',  body=(0xAB, 0x94, 0x7A), accent=(0x0E, 0xAF, 0x9B), build='std',
         nose='chamfer', tread='seg',   deck='ribbed', thrusters=3, sponson=True,
         tshape='hex',   tr=4.7, guns=1, bw=4, blen=7,  gap=0, optic=(12, 13)),
    dict(name='ravager', body=(0x9E, 0x45, 0x39), accent=(0xFB, 0xB9, 0x54), build='wide',
         nose='chamfer', tread='block', deck='plates', thrusters=4, sponson=False,
         tshape='round', tr=5.2, guns=2, bw=2, blen=7,  gap=3, optic=(12, 18)),
    dict(name='glacier', body=(0x9B, 0xAB, 0xB2), accent=(0x4D, 0x65, 0xB4), build='compact',
         nose='wedge',   tread='fine',  deck='plates', thrusters=2, sponson=False,
         tshape='box',   tr=4.5, guns=1, bw=2, blen=8,  gap=0, optic=(13, 13)),
    dict(name='obelisk', body=(0x7A, 0x30, 0x45), accent=(0xB3, 0x38, 0x31), build='long',
         nose='blunt',   tread='block', deck='ribbed', thrusters=4, sponson=True,
         tshape='wedge', tr=5.2, guns=2, bw=2, blen=9,  gap=3, optic=(12, 18)),
    # ---- super-heavy chassis ----
    dict(name='titan',     body=(0x3E, 0x35, 0x46), accent=(0xE8, 0x3B, 0x3B), build='super_heavy',
         nose='blunt',   tread='block', deck='ribbed', thrusters=4, sponson=True,
         tshape='hex',   tr=7.0, guns=2, bw=4, blen=8,  gap=5, optic=(11, 19)),
    dict(name='leviathan', body=(0x0B, 0x5E, 0x65), accent=(0x8F, 0xD3, 0xFF), build='super_long',
