...
from resurrect64 import nearest


def _snap_palette(p):
    """Snap every named colour in a PALETTES dict onto RESURRECT64, alpha
...
# Snapped onto RESURRECT64 below (_snap_palette) so every one of these stays
# on-palette; the literal RGB tuples here are the pre-Resurrect64 originals,
# kept as-is so the snap mapping is auditable/diffable against history.
_RAW_PALETTES = [
